...
from ShasaBot.modules.urluploader import download_file
from ShasaBot.pyrogramee.pluginshelper import humanbytes, progress

DOWNLOADPATH = "./ShasaBot/Downloads/"
